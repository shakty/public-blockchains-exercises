...
// setTimeout(() => console.log("Hello Brrrrendan!"), 2000);
...
let timeOut = setTimeout(() => console.log("Hello Brrrrendan!"), 2000);
clearTimeout(timeOut);
timeOut = setTimeout(() => console.log("Hello Biiiill!"), 2000);
clearTimeout(timeOut);
...
let fren = "Brendan";
setTimeout(() => console.log(`Hello ${fren}!`), 2000);
fren = "Bill";
...
interval2 = setInterval(() => console.log("Hello Billyyy!"), 1000);
setTimeout(() => {
    console.log(">>>>:c");
