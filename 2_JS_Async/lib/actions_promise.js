...
module.exports = function (doAsync = false, doSilly = false, doThrow = false) {
  ...
  // Open Fridge.
  ///////////////
  function openFridge(resolve, reject) {
  ...
  let takeButter = (function () {
    ...
    // Private function.
    function _justTakeTheButter(resolve, reject) {
    ...
    return function (resolve, reject) {
      ...
      if (Object.keys(fridge.stuff).length > 4) {
        ...
        setTimeout(() => { _justTakeTheButter(resolve, reject) }, 2000);
      }
      else {
        _justTakeTheButter(resolve, reject);
      }
    };
  })();
