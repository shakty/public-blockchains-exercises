...
async function main() {
    ...
    const { text, id } = await extractQuestion(quizContract, receipt);
    console.log(text);
    console.log(id);
    ...
    // Your code here.
    console.log()
    let tx2 = await quizContract.answerQuestion(id, userAnswer);
    console.log(tx2);
    ...
    console.log(`The awnser was ${correct ? "Correct!" : "False!"}` );
}
